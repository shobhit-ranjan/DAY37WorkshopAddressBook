	...
	public static void insertContact() {
		...
		if (conn != null) {
			...
			try {
				...
				preparedStatement.setString(1, "SHO");
				preparedStatement.setString(2, "RAN");
				preparedStatement.setString(3, "A 999");
				preparedStatement.setString(4, "Varanasi");
				preparedStatement.setString(5, "UP");
				preparedStatement.setInt(6, 211019);
				preparedStatement.setString(7, "8934788990");
				preparedStatement.setString(8, "ranh@gmail.com");
